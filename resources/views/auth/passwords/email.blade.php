    ...
    <div class="container my-5">
        <div class="row d-flex flex-row">
            ...
            <div class="row col-10 col-md-5 mx-auto">
                ...
                <h2 class="text-center py-4 fw-light text-secondary">RESET PASSWORD</h2>
                @if (session('status'))
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="email" type="email" class="form-control border-warning text-secondary @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="abc@gmail.com">
                        @error('email')
                    ...
                    <div class="text-center my-3">
                        <button type="button" class="main_btn">
                            <label class="fs-6">Reset Password</label>
